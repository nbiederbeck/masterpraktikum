...
\end{equation}
Ein alternativer Algorithmus zur Bestimmung der inversen Detektorfunktion ist beispielsweise das Forward Folding.

Des Weiteren neigt die Lösung zu starken Oszillation in $\vec{f}$.
