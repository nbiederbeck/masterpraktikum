...
Bei der Messung der transversalen Relaxationszeit werden die Peaks in der Meiboom-Gill-Methode
...
Jedoch muss hierbei berücksichtigt werden, dass die Temperatur während der Messung
schätzungsweise
\SI{22}{\celsius} betrug.

Die Bestimmung des Molekülradius von Wasser mit den verschiedenen Varianten zum Vergleich liegen alle im Bereich von \SIrange[range-phrase={\text{~bis~}}]{1.2}{1.8}{\angstrom},
