...
welcher das magnetisches Moment $\mu$ und den Drehimpuls $J$ verbindet.
\begin{equation}
		\label{eq:dreh}
...
ist der Fall für $\omega = \omega_\text{L}$ von besonderem Interesse da $B_eff$ =
$B_1$ ist.
...
Zustand herstellen.
Dies entspricht einem Spinflip der Elektronen. 
